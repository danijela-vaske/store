			...
			<div class="row">
				<div class=" col-md-3" style="margin-top:12px;" ng-repeat = "product in products">
					<div style="border:1px solid #333;
						...
						<input type="button" name="add_to_cart" style="margin-top:5px;" class="btn btn-success form-control" value="Add to Cart">
					</div>
				</div>
			</div>
			<br>
			<h3 align="center">Youre Cart Details</h3>
			<div class="table-responsive" id="order_table">
				<table class="table table-border table-striped">
					...
					<tr ng-repeat="cart in carts">
						...
						<td><button type="button" name="remove_product" class="btn btn-danger btn-xs">Remove</button></td>
					</tr>
					<tr>
